...
flowchart TD
    ...
    Filter --> Query[Systém vyhledá auta s baterií pod 30 % nebo nahlášenou závadou]
...
* **Technik:** Stará se o fyzickou údržbu aut v terénu. Potřebuje informace o stavu baterie pro plánování nabíjení a servisní režim pro práci na vozidle.
* **Provoz:** Celkově sleduje a mění stavy vozidel podle potřeby
...
* **POST /service** – Přijímá ID vozidla přímo v URL adrese a volitelný textový důvod poruchy. Vyřazuje vozidlo z oběhu a odesílá jej do servisu.
...
```
Očekávaný výsledek: Chybová hláška: Vozidlo není k dispozici <br>
